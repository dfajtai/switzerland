...
def pooled_test():
  ...
  snr, cnr = pooled_snr_cnr_on_df(df,"class_segmentation",["metastases_melanom"],target_cols)
  print("snr")
  print(snr)
  print("cnr")
  print(cnr)
  ...
  snr, cnr = pooled_snr_cnr_on_df(df,"class_segmentation",["metastases_lung"],target_cols)
  print("snr")
  print(snr)
  print("cnr")
  print(cnr)
